...
1. [-] - Guitar Note Component
   1. [-] - programmatically create an svg component
      ...
      9. [ ] - add note text to circles
	 1. [ ] - get formula to calculate octaves for all frets, begining with open fret
	 2. [ ] - add CORRECT octaves to text
	 3. [ ] - color by octaves
	 4. [ ] - add classes for note, octave, frequency
